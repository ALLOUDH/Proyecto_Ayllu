...
public class ListarProblemasReportero extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_problemas_reportero);
        ...
        lstProblemas = findViewById(R.id.lstProblemasReportero);
        listarProblemas();
    }
        ...
        AylluDatabase.child("Problemas_Recientes").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot objSnapchot : snapshot.getChildren()){
                    ...
                    problemaAdapter = new ProblemaAdapterReportero(ListarProblemasReportero.this,R.layout.recurso_adapter_problema_alternativo,listaProblemas);
                }
                arrayAdapterProblemas = new ArrayAdapter<ProblemaClase>
                        (ListarProblemasReportero.this, android.R.layout.simple_list_item_1,listaProblemas);
